...
file_dir = '/Users/weilixu/Desktop/data/scheulde/5ZoneTDV.idf'
...
results = new_sj.run(file_dir=file_dir, epw_dir=wea_dir, add_files='/Users/weilixu/Desktop/data/scheulde/csv', track=True)
